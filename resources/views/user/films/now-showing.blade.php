...
<main class="flex-grow bg-gray-900 text-white min-h-screen pt-12">
    <div class="container mx-auto px-4">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <span class="tracking-wider group-hover:tracking-widest transition-all duration-500">Coming Soon</span>
        </a>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            @empty
                <p class="text-center text-gray-400 col-span-full">Tidak ada film yang sedang tayang saat ini.</p>
            @endforelse
        </div>
    </div>
</main>
